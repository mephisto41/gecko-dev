                                            ...
                                            LayerManager* aManager)
{
  ...
  imageLayer->SetContainer(mImageContainer);
  nsAutoTArray<ImageContainer::NonOwningImage, 1> imageList;
  imageList.AppendElement(ImageContainer::NonOwningImage(mDisplayImage));
