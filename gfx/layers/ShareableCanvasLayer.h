...
/**
 * A shared CanvasLayer implementation that supports sharing
 * Composiables to compositor parent.
 */
...
protected:
  ...
  virtual bool UpdateTarget(gfx::DrawTarget* aDestTarget = nullptr);

  CanvasClient::CanvasClientType GetCanvasClientType();
